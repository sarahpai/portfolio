...
const Project = props => {
  return (
    <>
      <h2 className="header">
        <h2 id="tech-header">Technical</h2>
        &nbsp; portfolio
      </h2>
      ...
      <div className="project-info-01">
        ...
        <a
          ...
          href="https://www.github.com/sarahpai/photobooth-frontend"
          target="_blank">
          Github Frontend
        </a>
      </div>
      <div id="project-container">
        <div id="box-wrapper">
          <section className="box">
            ...
            <p className="description">
              Photo booth app that challenges user's creative photo taking
              skills through fun mission focused frames
            </p>
            ...
            <iframe
              ...
              height={315}
              title="reactbooth"
              src="https://www.youtube.com/embed/LEpe4KuZbeA"
              frameBorder="0"
        ...
        <div className="project-info-02">
          ...
          <a
            className="github-link"
            href="https://www.github.com/sarahpai/karaoke-frontend"
            target="_blank">
            GITHUB Frontend
          </a>
        </div>
        <div id="box-wrapper">
          <section className="box">
            ...
            <p className="description">
              Unlimited, free, and fun karaoking right from your screen!
            </p>
            ...
            <iframe
              ...
              height="315"
              title="youtube"
              src="https://www.youtube.com/embed/WXLtqoH3BVo"
              frameborder="0"
              allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
              allowfullscreen
            />
        ...
        <div className="project-info-03">
          ...
          <a
            className="github-link"
            href="https://www.github.com/sarahpai/mod2-final-project"
            target="_blank">
            GITHUB Frontend
          </a>
        </div>
        <div id="box-wrapper">
          <section className="box">
            ...
            <p className="description">
              Making reservations to the hottest restaurants in New York is just
              as easy as writing and awesome review!
            </p>
            ...
            <iframe
              ...
              height="315"
              title="yelpNtable"
              src="https://www.youtube.com/embed/O967-J5qUl4"
              frameborder="0"
              allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
              allowfullscreen
            />
